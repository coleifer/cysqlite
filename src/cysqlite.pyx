...
# Cython doesn't seem to provide a way to expose these without renaming them
# here or aliasing them in the header and then re-assigning.
C_SQLITE_OK = SQLITE_OK
C_SQLITE_ERROR = SQLITE_ERROR
C_SQLITE_INTERNAL = SQLITE_INTERNAL
C_SQLITE_PERM = SQLITE_PERM
C_SQLITE_ABORT = SQLITE_ABORT
C_SQLITE_BUSY = SQLITE_BUSY
C_SQLITE_LOCKED = SQLITE_LOCKED
C_SQLITE_NOMEM = SQLITE_NOMEM
C_SQLITE_READONLY = SQLITE_READONLY
C_SQLITE_INTERRUPT = SQLITE_INTERRUPT
C_SQLITE_IOERR = SQLITE_IOERR
C_SQLITE_CORRUPT = SQLITE_CORRUPT
C_SQLITE_NOTFOUND = SQLITE_NOTFOUND
C_SQLITE_FULL = SQLITE_FULL
C_SQLITE_CANTOPEN = SQLITE_CANTOPEN
C_SQLITE_PROTOCOL = SQLITE_PROTOCOL
C_SQLITE_EMPTY = SQLITE_EMPTY
C_SQLITE_SCHEMA = SQLITE_SCHEMA
C_SQLITE_TOOBIG = SQLITE_TOOBIG
C_SQLITE_CONSTRAINT = SQLITE_CONSTRAINT
C_SQLITE_MISMATCH = SQLITE_MISMATCH
C_SQLITE_MISUSE = SQLITE_MISUSE
C_SQLITE_NOLFS = SQLITE_NOLFS
C_SQLITE_AUTH = SQLITE_AUTH
C_SQLITE_FORMAT = SQLITE_FORMAT
C_SQLITE_RANGE = SQLITE_RANGE
C_SQLITE_NOTADB = SQLITE_NOTADB
C_SQLITE_ROW = SQLITE_ROW
C_SQLITE_DONE = SQLITE_DONE

# Status.
C_SQLITE_STATUS_MEMORY_USED = SQLITE_STATUS_MEMORY_USED
C_SQLITE_STATUS_PAGECACHE_USED = SQLITE_STATUS_PAGECACHE_USED
C_SQLITE_STATUS_PAGECACHE_OVERFLOW = SQLITE_STATUS_PAGECACHE_OVERFLOW
C_SQLITE_STATUS_SCRATCH_USED = SQLITE_STATUS_SCRATCH_USED
C_SQLITE_STATUS_SCRATCH_OVERFLOW = SQLITE_STATUS_SCRATCH_OVERFLOW
C_SQLITE_STATUS_MALLOC_SIZE = SQLITE_STATUS_MALLOC_SIZE
C_SQLITE_STATUS_PARSER_STACK = SQLITE_STATUS_PARSER_STACK
C_SQLITE_STATUS_PAGECACHE_SIZE = SQLITE_STATUS_PAGECACHE_SIZE
C_SQLITE_STATUS_SCRATCH_SIZE = SQLITE_STATUS_SCRATCH_SIZE
C_SQLITE_STATUS_MALLOC_COUNT = SQLITE_STATUS_MALLOC_COUNT
C_SQLITE_DBSTATUS_LOOKASIDE_USED = SQLITE_DBSTATUS_LOOKASIDE_USED
C_SQLITE_DBSTATUS_CACHE_USED = SQLITE_DBSTATUS_CACHE_USED
C_SQLITE_DBSTATUS_SCHEMA_USED = SQLITE_DBSTATUS_SCHEMA_USED
C_SQLITE_DBSTATUS_STMT_USED = SQLITE_DBSTATUS_STMT_USED
C_SQLITE_DBSTATUS_LOOKASIDE_HIT = SQLITE_DBSTATUS_LOOKASIDE_HIT
C_SQLITE_DBSTATUS_LOOKASIDE_MISS_SIZE = SQLITE_DBSTATUS_LOOKASIDE_MISS_SIZE
C_SQLITE_DBSTATUS_LOOKASIDE_MISS_FULL = SQLITE_DBSTATUS_LOOKASIDE_MISS_FULL
C_SQLITE_DBSTATUS_CACHE_HIT = SQLITE_DBSTATUS_CACHE_HIT
C_SQLITE_DBSTATUS_CACHE_MISS = SQLITE_DBSTATUS_CACHE_MISS
C_SQLITE_DBSTATUS_CACHE_WRITE = SQLITE_DBSTATUS_CACHE_WRITE
C_SQLITE_DBSTATUS_DEFERRED_FKS = SQLITE_DBSTATUS_DEFERRED_FKS

# Authorizer.
C_SQLITE_CREATE_INDEX = SQLITE_CREATE_INDEX
C_SQLITE_CREATE_TABLE = SQLITE_CREATE_TABLE
C_SQLITE_CREATE_TEMP_INDEX = SQLITE_CREATE_TEMP_INDEX
C_SQLITE_CREATE_TEMP_TABLE = SQLITE_CREATE_TEMP_TABLE
C_SQLITE_CREATE_TEMP_TRIGGER = SQLITE_CREATE_TEMP_TRIGGER
C_SQLITE_CREATE_TEMP_VIEW = SQLITE_CREATE_TEMP_VIEW
C_SQLITE_CREATE_TRIGGER = SQLITE_CREATE_TRIGGER
C_SQLITE_CREATE_VIEW = SQLITE_CREATE_VIEW
C_SQLITE_DELETE = SQLITE_DELETE
C_SQLITE_DROP_INDEX = SQLITE_DROP_INDEX
C_SQLITE_DROP_TABLE = SQLITE_DROP_TABLE
C_SQLITE_DROP_TEMP_INDEX = SQLITE_DROP_TEMP_INDEX
C_SQLITE_DROP_TEMP_TABLE = SQLITE_DROP_TEMP_TABLE
C_SQLITE_DROP_TEMP_TRIGGER = SQLITE_DROP_TEMP_TRIGGER
C_SQLITE_DROP_TEMP_VIEW = SQLITE_DROP_TEMP_VIEW
C_SQLITE_DROP_TRIGGER = SQLITE_DROP_TRIGGER
C_SQLITE_DROP_VIEW = SQLITE_DROP_VIEW
C_SQLITE_INSERT = SQLITE_INSERT
C_SQLITE_PRAGMA = SQLITE_PRAGMA
C_SQLITE_READ = SQLITE_READ
C_SQLITE_SELECT = SQLITE_SELECT
C_SQLITE_TRANSACTION = SQLITE_TRANSACTION
C_SQLITE_UPDATE = SQLITE_UPDATE
C_SQLITE_ATTACH = SQLITE_ATTACH
C_SQLITE_DETACH = SQLITE_DETACH
C_SQLITE_ALTER_TABLE = SQLITE_ALTER_TABLE
C_SQLITE_REINDEX = SQLITE_REINDEX
C_SQLITE_ANALYZE = SQLITE_ANALYZE
C_SQLITE_CREATE_VTABLE = SQLITE_CREATE_VTABLE
C_SQLITE_DROP_VTABLE = SQLITE_DROP_VTABLE
C_SQLITE_FUNCTION = SQLITE_FUNCTION
C_SQLITE_SAVEPOINT = SQLITE_SAVEPOINT
C_SQLITE_COPY = SQLITE_COPY
C_SQLITE_RECURSIVE = SQLITE_RECURSIVE
C_SQLITE_DENY = SQLITE_DENY
C_SQLITE_IGNORE = SQLITE_IGNORE

C_SQLITE_OPEN_READONLY = SQLITE_OPEN_READONLY
C_SQLITE_OPEN_READWRITE = SQLITE_OPEN_READWRITE
C_SQLITE_OPEN_CREATE = SQLITE_OPEN_CREATE
C_SQLITE_OPEN_DELETEONCLOSE = SQLITE_OPEN_DELETEONCLOSE
C_SQLITE_OPEN_EXCLUSIVE = SQLITE_OPEN_EXCLUSIVE
C_SQLITE_OPEN_AUTOPROXY = SQLITE_OPEN_AUTOPROXY
C_SQLITE_OPEN_URI = SQLITE_OPEN_URI
C_SQLITE_OPEN_MEMORY = SQLITE_OPEN_MEMORY
C_SQLITE_OPEN_MAIN_DB = SQLITE_OPEN_MAIN_DB
C_SQLITE_OPEN_TEMP_DB = SQLITE_OPEN_TEMP_DB
C_SQLITE_OPEN_TRANSIENT_DB = SQLITE_OPEN_TRANSIENT_DB
C_SQLITE_OPEN_MAIN_JOURNAL = SQLITE_OPEN_MAIN_JOURNAL
C_SQLITE_OPEN_TEMP_JOURNAL = SQLITE_OPEN_TEMP_JOURNAL
C_SQLITE_OPEN_SUBJOURNAL = SQLITE_OPEN_SUBJOURNAL
C_SQLITE_OPEN_MASTER_JOURNAL = SQLITE_OPEN_MASTER_JOURNAL
C_SQLITE_OPEN_NOMUTEX = SQLITE_OPEN_NOMUTEX
C_SQLITE_OPEN_FULLMUTEX = SQLITE_OPEN_FULLMUTEX
